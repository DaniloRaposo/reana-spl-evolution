...
public class Analyzer {
    ...
    public IReliabilityAnalysisResults evaluateFeatureFamilyBasedReliabilityWithEvolution(RDGNode node, String dotOutput, String idFragment) throws CyclicRdgException {
        return featureFamilyBasedAnalyzerImpl.evaluateReliabilityWithEvolution(node, this.concurrencyStrategy, dotOutput, idFragment);
    }
    /**
    /**
     * Evaluates the feature-family-based reliability function of an RDG node, based
